...
The relevant log points in [`simp_fun.py`](../../../../examples/interface/vitis_regmap_simp_fun/simp_fun.py):
...
```python
# examples/interface/vitis_regmap_simp_fun/simp_fun_build.py — ExtractPyTimingStep.run
